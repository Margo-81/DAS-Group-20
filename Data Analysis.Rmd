...
skim20<-skimr::skim(dataset20)#View data
library(knitr)
kable(skim20, format = "latex")
...
glimpse20<-glimpse(dataset20)#View the structure of data
kable(glimpse20, format = "latex")
```
...
pie1<-pie(animal_counts, labels = names(animal_counts),main = "Pie Chart of Animal Type")
intake_counts <- table(dataset20$intake_type)
pie2<-pie(intake_counts, labels = names(intake_counts), main = "Pie Chart of Intake Type")
outcome_counts <- table(dataset20$outcome_type)
pie3<-pie(outcome_counts, labels = names(outcome_counts), main = "Pie Chart of Outcome Type")
chip_status <- table(dataset20$chip_status)
pie4<-pie(chip_status, labels = names(chip_status), main = "Pie Chart of Chip Status")
library(gridExtra)
