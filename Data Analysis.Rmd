...
setwd("C:/Users/dell/Desktop/DA/DAS-Group-20")
...
fit1<-glm(time_at_shelter~intake_type+outcome_type+chip_status,
...
fit2<- lm(time_at_shelter~intake_type+outcome_type+chip_status,
...
fit3<-glm(time_at_shelter~intake_type+outcome_type+chip_status,data=dataset20,
